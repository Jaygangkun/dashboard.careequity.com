...
$(document).ready(function () {
    ...
    $(document).on('click', '#report_add_btn', function () {
        ...
        $.ajax({
            url: base_url + 'biorxiv/admin_api/report_add',
            type: 'post',
            data: {
                'title': $('#title').val(),
                'conditions': $('#term').val(),
    ...
    function updateReport(report_id) {
        ...
        $.ajax({
            url: base_url + 'biorxiv/admin_api/report_update',
            type: 'post',
            data: {
                'id': report_id,
    ...
    function searchReport(keyword, sort) {
        $.ajax({
            url: base_url + 'biorxiv/admin_api/report_search',
            type: 'post',
            data: {
                keyword: keyword,
                sort: sort
            ...
            success: function (resp) {
                resp = JSON.parse(resp);
                if (resp.success) {
                    $('#dashboard_biorxiv #report_list').html(resp.reports);
                }
                else {
                    $('#dashboard_biorxiv #report_list').html('');
                }
            }
        })
    }

    $(document).on('keypress', '#dashboard_biorxiv #report_search_input', function (event) {
        var keycode = (event.keyCode ? event.keyCode : event.which);
        if (keycode == '13') {
            searchReport($(this).val(), $('#dashboard_biorxiv #sort').val())
        }
    })

    $(document).on('click', '#dashboard_biorxiv .search-input-icon', function () {
        searchReport($("#dashboard_biorxiv #report_search_input").val(), $('#dashboard_biorxiv #sort').val());
    })

    // sort
    $(document).on('change', '#dashboard_biorxiv #sort', function () {
        searchReport($('#dashboard_biorxiv #report_search_input').val(), $(this).val());
    })
    ...
    $(document).on('click', '.report-list-action-popup-btn--reporting', function () {
        ...
        $(report_row).addClass('loading');
        $.ajax({
            url: base_url + 'biorxiv/admin_api/report_reporting',
            type: 'post',
            data: {
                'id': report_id,
                reporting: reporting
    ...
    $(document).on('click', '.report-list-action-popup-btn--duplicate', function () {
        ...
        $(report_row).addClass('loading');
        $.ajax({
            url: base_url + 'biorxiv/admin_api/report_duplicate',
            type: 'post',
            data: {
                'id': report_id,
            },
    ...
    $(document).on('click', '.report-list-action-popup-btn--delete', function () {
        ...
        showConfirm({
            ...
            $(report_row).addClass('loading');
            $.ajax({
                url: base_url + 'biorxiv/admin_api/report_delete',
                type: 'post',
                data: {
                    'id': report_id,
                },
    ...
    $(document).on('click', '#dashboard_biorxiv .report-list-download-btn', function () {
        var report_id = $(this).parents('.report-list-row').attr('report-id');
        window.open(base_url + 'biorxiv/admin_api/rss_download?report_id=' + report_id, '_blank');
    })

    $(document).on('click', '#dashboard_biorxiv #title', function (event) {
    ...
    $(document).on('click', '#dashboard_biorxiv .report-add-area', function (event) {
    ...
    $(document).on('click', '.btn-user-delete', function () {
        ...
        showConfirm({
            ...
            $.ajax({
                url: base_url + 'biorxiv/admin_api/user_delete',
                type: 'post',
                data: {
                    'user_id': user_id,
                },
    ...
    $(document).on("click", "#dashboard_biorxiv .show_line_btn", function () {
        ...
        $("#dashboard_biorxiv .date_picker_wrap").attr("report-id", report_id);
        $("#dashboard_biorxiv .report_date-downlaod").attr("report-id", report_id);

        $("#dashboard_biorxiv #start_date_biorxiv").val("");
        $("#dashboard_biorxiv #last_date_biorxiv").val("");



        $.ajax({
            url: base_url + 'biorxiv/admin_api/report_get_week_list',
            type: 'post',
            data: {
                'id': report_id,
            },
            success: function (resp) {
                ...
                if (resp.week_list == null || resp.week_list == "") {
                    ...
                    $('#dashboard_biorxiv .graph-songs').graphiq({
                        data: week_val_obj,
                        fluidParent: ".col",
                        height: 100,
                        xLineCount: 10,
                    ...
                    $('#dashboard_biorxiv .graph-songs_total').graphiq({
                        data: week_val_obj,
                        fluidParent: ".col",
                        height: 200,
                        xLineCount: 10,
                ...
                $("#dashboard_biorxiv .modal-title").text(title);
        ...
        //remove
        $("#dashboard_biorxiv .graph-songs").empty();
        $("#dashboard_biorxiv .graph-songs_total").empty();


        $("#dashboard_biorxiv .show_modal_btn").trigger("click");
    });
    ...
    //date pikcer
    $("#dashboard_biorxiv #start_date_biorxiv").datepicker({
        dateFormat: 'mm / dd / yy',
        maxDate: 0,
        onSelect: function (dateText) {
            ...
            var last_difference_in_day = $("#dashboard_biorxiv #last_date_biorxiv").val();
            if (last_difference_in_day == "") {
                $('#dashboard_biorxiv #last_date_biorxiv').datepicker("setDate", new Date(today));
                last_difference_in_day = $("#dashboard_biorxiv #last_date_biorxiv").val();
            }
            ...
            $('#dashboard_biorxiv #last_date_biorxiv').datepicker("option", "minDate", selected_date);


            var report_id = $("#dashboard_biorxiv .date_picker_wrap").attr("report-id");
    ...
    $("#dashboard_biorxiv #last_date_biorxiv").datepicker(
        {
            dateFormat: 'mm / dd / yy',
            maxDate: 0,
            onSelect: function (dateText) {
                ...
                var last_difference_in_day = $("#dashboard_biorxiv #start_date_biorxiv").val();

                if (last_difference_in_day == "") {
                    $('#dashboard_biorxiv #start_date_biorxiv').datepicker("setDate", new Date(selected_date));
                    last_difference_in_day = $("#dashboard_biorxiv #start_date_biorxiv").val();
                }
                ...
                $('#dashboard_biorxiv #start_date_biorxiv').datepicker("option", "maxDate", selected_date);
    ...
    $(document).on("click", "#dashboard_biorxiv .set_third_days_btn", function () {

        var today = new Date();
        var priorDate = new Date(new Date().setDate(today.getDate() - 30));

        $('#dashboard_biorxiv #start_date_biorxiv').datepicker("setDate", new Date(priorDate));
        $('#dashboard_biorxiv #last_date_biorxiv').datepicker("setDate", new Date(today));

        $('#dashboard_biorxiv #start_date_biorxiv').datepicker("option", "maxDate", today);
        $('#dashboard_biorxiv #last_date_biorxiv').datepicker("option", "maxDate", today);
    ...
    $(document).on("click", "#dashboard_biorxiv .change_display_cumulative", function () {
        $("#dashboard_biorxiv .graph-songs_wrap").css("display", "none");
        $("#dashboard_biorxiv .graph-songs_total_wrap").css("display", "block");

        if ($("#dashboard_biorxiv .change_display_daily").hasClass('active')) {
            $("#dashboard_biorxiv .change_display_daily").removeClass('active');
            $("#dashboard_biorxiv .change_display_cumulative").addClass('active');
        }

    });

    $(document).on("click", "#dashboard_biorxiv .change_display_daily", function () {
        $("#dashboard_biorxiv .graph-songs_wrap").css("display", "block");
        $("#dashboard_biorxiv .graph-songs_total_wrap").css("display", "none");

        if ($("#dashboard_biorxiv .change_display_cumulative").hasClass('active')) {
            $("#dashboard_biorxiv .change_display_cumulative").removeClass('active');
            $("#dashboard_biorxiv .change_display_daily").addClass('active');
        }
    });
    ...
    $(document).on("click", "#dashboard_biorxiv .report-list-col-status", function () {
        ...
        $("#dashboard_biorxiv .popup-title").text(name_title);


        $.ajax({
            url: base_url + 'biorxiv/admin_api/popup_update',
            type: 'post',
            data: {
                'id': report_id,
            },
            success: function (resp) {
                ...
                for (const clinic of resp.clinics) {
                    ...
                    tbody_string += "<tr><td class='number_td'>" + number + "</td><td>" + clinic.identifier + "</td><td class='title_td'>" + clinic.title + "</td><td>" + clinic.creator + "</td><td>" + today + "</td>\
                    <td class='link_td'><a href='"+ clinic.link + "' target='_blank'><img src='" + img_url + "'></a></td></tr>";

                    number += 1;
                }
                $("#dashboard_biorxiv .popup_body").html(tbody_string);
                ...
                $("#dashboard_biorxiv .popup_updates_count").text(update_numbers);

            }
        })

        $("#dashboard_biorxiv .show_popup_btn").trigger("click");
    ...
    //download pdf
    $(document).on("click", "#dashboard_biorxiv .download_list_report_btn", function () {


        var report_id = $(this).parents('.report-list-row').attr('report-id');
        window.open(base_url + 'biorxiv/admin_api/download_csv?report_id=' + report_id, '_blank');
    })


     //download dates csv
     $(document).on("click", "#dashboard_biorxiv .report_date-downlaod", function () {

        var report_id = $(this).attr('report-id');

        var start = $("#dashboard_biorxiv #start_date_biorxiv").val();
        var last = $("#dashboard_biorxiv #last_date_biorxiv").val();
        ...
        if (start == "") {
            ...
            window.open(base_url + 'biorxiv/admin_api/download_dates_csv?report_id=' + report_id +'&start_date=' + start_difference +'&last_date=' + last_difference +'&last_date_day=' + last_date_day + '&start_date_day=' + start_date_day, '_blank');
        }
