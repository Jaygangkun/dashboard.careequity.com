<div id="dashboard_biorxiv">
	<div class="report-add-area">
		<div class="container">
			<h3 class="area-title">Biorxiv Search Parameters</h3>
	...
	<div class="report-list-area">
		<div class="container">
			...
			<div class="report-list-body" id="report_list">
				...
				if (isset($reports)) {
					foreach ($reports as $report) {
						...
						$this->view('biorxiv/template/report-template', $data);
					}
				}
				?>
			</div>
			...
			<button type="button" class="btn btn-info btn-lg show_modal_btn" data-toggle="modal" data-target="#dashboard_biorxiv #myModal">Open Modal</button>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div class="date_picker_wrap">
								...
								<div>
									<?php $attributes = 'id="start_date_biorxiv" placeholder="Select Start Date"';
									echo form_input('start_date', set_value('start_date'), $attributes); ?>
									-
									<?php $attributes = 'id="last_date_biorxiv" placeholder="Select Last Date"';
			...
			<!-- Trigger the modal with a button -->
			<button type="button" class="btn btn-info btn-lg show_popup_btn" data-toggle="modal" data-target="#dashboard_biorxiv #myPopup">Open Modal</button>
						...
						<div class="modal-body">
							...
							<table class="popup-table">
								<thead>
									<tr>
										<th style="width: 2%"></th>
										<th style="width: 25%">NCT number</th>
...
<script src="<?= base_url() ?>assets/js/biorxiv/app.js?v=<?php echo time() ?>"></script>