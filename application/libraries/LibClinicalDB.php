...
class LibClinicalDB 
{
	...
	{
		$CI =& get_instance();
		$db = $CI->load->database('clinical', TRUE); // the TRUE paramater tells CI that you'd like to return the database object.
	...
	public function reports_all_saved($report_id)
	{
		$CI =& get_instance();
		$db = $CI->load->database('clinical', TRUE); // the TRUE paramater tells CI that you'd like to return the database object.
